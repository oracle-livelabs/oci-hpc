...
5.  OpenFoamアプリケーションは"/mnt/gluster-share/work"フォルダにホストされます。ワークロードが実行される2つのHPCノードのpriavte IPアドレスを含むhostfileを確認します。 ![市場](images/19-Bastion_openfoam.png)
