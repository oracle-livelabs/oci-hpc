...
1.  使用者啟動市集映像檔之前，請先檢查有 2 個或更多 HPC 節點可用資源配置 BM.HPC2.36 的可用性網域。前往功能表 -> 治理 -> 限制、配額和用量 ![市場](images/01-Service_Limits.png)
...
9.  螢幕上將顯示如下的影像。根據某些顯示設定，畫面上的影像看起來可能有點不同。 ![市場](images/27-Image_Rendering.png)
